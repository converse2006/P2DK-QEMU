	...
	;-----------------------------------------------------------
	; Compiling /home/converse/virtual_platform1/testsuit/standalone/sha-input_8/sha_driver.c (sha_driver.B)
	;-----------------------------------------------------------
	...
	.file	2	"/home/converse/virtual_platform1/testsuit/standalone/sha-input_8/sha_driver.c"
...
; Block: 1 Pred: Succ: 2 
; BB:1 cycle count: 0
.BB1_sha_dbg_print:	; 0xc8
	.loc	2	5	0
;   1  #include "sha.h"
;   2  
;   3  #ifdef DEBUG_SHA_STAGE
;   4  void sha_dbg_print(SHA_INFO *sha_info)
;   5  {
 {  
;	.prologue
	      subi sp3,sp3,32 ;;      		; [] 
...
; BB:2 cycle count: 0
.BB2_sha_dbg_print:	; 0xff
 {  
	      nop ;;                  		; [] 
	.loc	2	7	0
;   7      puth(sha_info->digest[0]);
...
; BB:4 cycle count: 0
.BB4_sha_dbg_print:	; 0x177
 {  
	      nop ;;                  		; [] 
	.loc	2	9	0
;   9      puth(sha_info->digest[1]);
	      addi a3,sp,32           		; [] sha_info
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
; BB:6 cycle count: 0
.BB6_sha_dbg_print:	; 0x1ef
 {  
	      nop ;;                  		; [] 
	.loc	2	11	0
;  11      puth(sha_info->digest[2]);
	      addi a3,sp,32           		; [] sha_info
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
; BB:8 cycle count: 0
.BB8_sha_dbg_print:	; 0x267
 {  
	      nop ;;                  		; [] 
	.loc	2	13	0
;  13      puth(sha_info->digest[3]);
	      addi a3,sp,32           		; [] sha_info
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
; BB:10 cycle count: 0
.BB10_sha_dbg_print:	; 0x2df
 {  
	      nop ;;                  		; [] 
	.loc	2	15	0
;  15      puth(sha_info->digest[4]);
	      addi a3,sp,32           		; [] sha_info
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
;	.savesp r7, 0
	      sw r7,sp3,108 ;;        		; [] lcl_spill_temp_3
	.loc	2	24	0
...
;  29  	return sha_info.digest[0];
	      lw r7,sp3,108 ;;        		; [] lcl_spill_temp_3
...
;PU cycle count: 0.000000
	...
	.org 0x8
	; offset 8
	.byte	0x23, 0x20, 0x66, 0x69, 0x6c, 0x65, 0x3a, 0x20	; # file: 
	.byte	0x69, 0x6e, 0x70, 0x75, 0x74, 0x5f, 0x74, 0x69	; input_ti
	.byte	0x6e, 0x79, 0x32, 0x2e, 0x62, 0x69, 0x6e, 0xa	; ny2.bin\n
	.byte	0x0	; \000
	.section .text
	.align 4
	.section .rodata
...
;	.gpvalue 0
	...
	.align	0
	.byte	0x76, 0x01, 0x00, 0x00, 0x02, 0x00
	.int.ua	.debug_abbrev
	...
	.int.ua	0x732f385f, 0x645f6168, 0x65766972, 0x00632e72
	...
	.int.ua	0x62617475, 0x732f656c, 0x692d6168, 0x7475706e
	.int.ua	0x6e69745f, 0x00322d79, 0x6e65706f, 0x34206363
	...
	.int.ua	0x000000ee, 0x6d630403, 0x02006773, 0x02000091
	.int.ua	0x70706604, 0x6e65735f, 0x626d5f64, 0x0300786f
	.byte	0x92, 0x30, 0x20
	.int.ua	.BB1_pp_send_mbox
	.int.ua	.BB1_pp_send_mbox + 0x64
	.int.ua	0x00000119, 0x6d660403, 0x02006773, 0x04000091
	.int.ua	0x68730502, 0x62645f61, 0x72705f67, 0x00746e69
	.byte	0x01, 0x03, 0x92, 0x30, 0x20
	.int.ua	.BB1_sha_dbg_print
	.int.ua	.BB1_sha_dbg_print + 0x2bc
	.int.ua	0x0000014b, 0x73050203, 0x695f6168, 0x006f666e
	.int.ua	0x00009102, 0x6d150205, 0x006e6961, 0x30920401
	.byte	0xf0, 0x00
	.int.ua	.BB1_main
	.int.ua	.BB1_main + 0xaf
	...
	.int.ua	.BB1_pp_wait_mbox
	.int.ua	.BB1_main - .BB1_pp_wait_mbox + 0xaf
	...
	.int.ua	.debug_info
	.int.ua	0x0000017a, 0x00000119, 0x5f616873, 0x5f676264
	.int.ua	0x6e697270, 0x014b0074, 0x616d0000, 0x00006e69
	.byte	0x00, 0x00, 0x00
