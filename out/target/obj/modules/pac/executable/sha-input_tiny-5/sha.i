...
extern unsigned char _binary_input_tiny5_bin_start[];
extern unsigned char _binary_input_tiny5_bin_end[];
...
{
    int i,j;
    unsigned int size = _binary_input_tiny5_bin_end - _binary_input_tiny5_bin_start;
    BYTE data[8192];
    ...
    for(i = 0, j=0 ; i < size; i++) {
        ...
        data[j] = _binary_input_tiny5_bin_start[i];
        j += 1;
