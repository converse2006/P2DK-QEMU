# 1 "/home/converse/virtual_platform1/testsuit/hybrid/crc32/crc_32.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/converse/virtual_platform1/testsuit/hybrid/crc32/crc_32.c"
...
{pp_mbox_send_w(msg);}
# 7 "/home/converse/virtual_platform1/testsuit/hybrid/crc32/crc_32.c" 2
...
# 8 "/home/converse/virtual_platform1/testsuit/hybrid/crc32/crc_32.c" 2
# 1 "/home/converse/virtual_platform1/testsuit/hybrid/crc32/crc.h" 1
# 10 "/home/converse/virtual_platform1/testsuit/hybrid/crc32/crc.h"
...
# 9 "/home/converse/virtual_platform1/testsuit/hybrid/crc32/crc_32.c" 2

unsigned char __attribute__((section(".ldm_shared"), aligned(4))) inbuffer[(16*1024)];
unsigned char __attribute__((section(".ldm_shared"), aligned(4))) outbuffer[4];
# 27 "/home/converse/virtual_platform1/testsuit/hybrid/crc32/crc_32.c"
typedef uint32_t UNS_32_BITS;
# 75 "/home/converse/virtual_platform1/testsuit/hybrid/crc32/crc_32.c"
static uint32_t __attribute__((section(".ldm"), aligned(4))) crc_32_tab[] = {
...
static uint32_t __attribute__((section(".ldm"), aligned(4))) lastcrc32;

static inline void start_crc32()
{
    ;
    lastcrc32 = 0xffffffff;
}

void process_crc32(const int sz)
{
    register uint32_t oldcrc32;
    register int i;
    const register char* in = inbuffer;
    const register uint32_t* tab = crc_32_tab;
    ...
    oldcrc32 = lastcrc32;
    for(i = 0; i < sz; i++) {
        oldcrc32 = (tab[((oldcrc32)^((uint8_t)in[i])) & 0xff] ^ ((oldcrc32) >> 8));
...
static inline void final_crc32()
{
    uint32_t ret;
    ;
    ;
    ...
    outbuffer[0] = (lastcrc32 >> 24) & 0xff;
    outbuffer[1] = (lastcrc32 >> 16) & 0xff;
    outbuffer[2] = (lastcrc32 >> 8) & 0xff;
    outbuffer[3] = lastcrc32 & 0xff;
    puts("done\n\n");
}
