	...
	;-----------------------------------------------------------
	; Compiling /home/converse/virtual_platform1/testsuit/standalone/nthu/DSPStone/n_complex_updates.c (n_complex_updates.B)
	;-----------------------------------------------------------
	...
	.file	1	"/home/converse/virtual_platform1/out/target/obj/modules/pac/executable/n_complex_updates-pllab/<command-line>"
	.file	2	"/home/converse/virtual_platform1/testsuit/standalone/nthu/DSPStone/n_complex_updates.c"
...
;  44  
;  45  void
;  46  pin_down(TYPE *pa, TYPE *pb, TYPE *pc, TYPE *pd)
;  47  {
 {  
;	.prologue
	      subi sp3,sp3,16 ;;      		; [] 
...
main#:	; 0x627
	...
	; i = 32
	; sum = 44
	; __save_expr_temp_0 = 36
	; __save_expr_temp_1 = 40
	; lcl_spill_temp_3 = 48
; Block: 1 Pred: Succ: 2 
; BB:1 cycle count: 0
.BB1_main:	; 0x627
...
;	.savesp r7, 0
	      sw r7,sp3,48 ;;         		; [] lcl_spill_temp_3
	      nop                     		; [] 
	      nop                     		; [] 
	.loc	2	69	0
;  67    static TYPE A[2*N], B[2*N], C[2*N], D[2*N] ; 
;  68    
;  69    STORAGE_CLASS TYPE *p_a = &A[0], *p_b = &B[0] ;
	      ...
	      nop                     		; [] 
	.loc	2	70	0
;  70    STORAGE_CLASS TYPE *p_c = &C[0], *p_d = &D[0] ;
	      addi A3,gp2,@ltoff(.bss#)		; [] .bss
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      ...
	      nop                     		; [] 
	.loc	2	79	0
;  75  	short temph, templ ;
;  76  	int temp ; 
;  77    #endif
;  78    #ifndef INTRN
;  79    pin_down(&A[0], &B[0], &C[0], &D[0]) ; 
	      addi A3,gp2,@ltoff(.bss#)		; [] .bss
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
...
.BB2_main:	; 0x721
 {  
	      ...
	      nop                     		; [] 
	.loc	2	112	0
; 108  		D[i+1] = C[i+1] + A[i+1] * B[i] ;
; 109  		D[i+1] += A[i] * B[i+1] ;
; 110  	}
; 111    #else
; 112    	for (i = 0 ; i < N ; i++, p_a++)
	      movi D8,0               		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
...
; 115  		    *p_d++ -=          *p_a   * *p_b-- ;
	      ...
	      nop                     		; [] 
	      nop                     		; [] 
	      sw D0,sp2,36            		; [] __save_expr_temp_0
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      ...
	      nop                     		; [] 
	      nop                     		; [] 
	      lw A4,sp2,36            		; [] __save_expr_temp_0
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      ...
	      nop                     		; [] 
	      nop                     		; [] 
	      lw A3,sp2,36            		; [] __save_expr_temp_0
	      sub D0,D0,D3            		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
...
; 117  	            *p_d++ +=          *p_a++ * *p_b++ ;
	      ...
	      nop                     		; [] 
	      nop                     		; [] 
	      sw D0,sp2,40            		; [] __save_expr_temp_1
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      ...
	      nop                     		; [] 
	      nop                     		; [] 
	      lw A5,sp2,40            		; [] __save_expr_temp_1
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      ...
	      nop                     		; [] 
	      nop                     		; [] 
	      lw A3,sp2,40            		; [] __save_expr_temp_1
	      add D0,D0,D3            		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
...
;	.gpvalue 0
	...
	.align	0
	.byte	0x3e, 0x02, 0x00, 0x00, 0x02, 0x00
	.int.ua	.debug_abbrev
	...
	.int.ua	0x656e6f74, 0x635f6e2f, 0x6c706d6f, 0x755f7865
	.int.ua	0x74616470, 0x632e7365, 0x6f682f00, 0x632f656d
	...
	.int.ua	0x6f635f6e, 0x656c706d, 0x70755f78, 0x65746164
	.int.ua	0x6c702d73, 0x0062616c, 0x6e65706f, 0x34206363
	...
	.int.ua	0x00000101, 0x63090303, 0x00910200, 0x78090303
	...
	.int.ua	0x0000013d, 0x630e0303, 0x00910200, 0x610e0303
	...
	.int.ua	0x000001e8, 0x63280303, 0x00910200, 0x2f020400
	.byte	0x70, 0x69, 0x6e, 0x5f, 0x64, 0x6f, 0x77, 0x6e
	.byte	0x00, 0x01, 0x03, 0x92, 0x30, 0x10
	.int.ua	.BB1_pin_down
	.int.ua	.BB1_pin_down + 0x1cc
	.int.ua	0x0000022a, 0x702f0203, 0x91020061, 0x2f020300
	.int.ua	0x02006270, 0x02030491, 0x0063702f, 0x03089102
	.int.ua	0x64702f02, 0x0c910200, 0x42020500, 0x6e69616d
	.byte	0x00, 0x01, 0x04, 0x92, 0x30, 0xc0, 0x00
	.int.ua	.BB1_main
	.int.ua	.BB1_main + 0x4bf
	.byte	0x00, 0x00
	...
	.int.ua	.BB1_ck_add_16
	.int.ua	.BB1_main - .BB1_ck_add_16 + 0x4bf
	...
	.int.ua	.debug_info
	.int.ua	0x00000242, 0x000001e8, 0x5f6e6970, 0x6e776f64
	.byte	0x00, 0x2a, 0x02, 0x00, 0x00, 0x6d, 0x61, 0x69
