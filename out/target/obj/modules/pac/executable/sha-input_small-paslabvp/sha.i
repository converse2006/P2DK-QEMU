# 1 "/home/converse/virtual_platform1/testsuit/standalone/sha-input_small/sha.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/converse/virtual_platform1/testsuit/standalone/sha-input_small/sha.c"
...
# 1 "/home/converse/virtual_platform1/testsuit/standalone/sha-input_small/sha.h" 1
...
{pp_mbox_send_w(msg);}
# 5 "/home/converse/virtual_platform1/testsuit/standalone/sha-input_small/sha.h" 2
...
# 43 "/home/converse/virtual_platform1/testsuit/standalone/sha-input_small/sha.h"
extern unsigned char _binary_input_small_bin_start[];
extern unsigned char _binary_input_small_bin_end[];
extern unsigned char sha_result_start[];
extern unsigned char sha_result_end[];
# 6 "/home/converse/virtual_platform1/testsuit/standalone/sha-input_small/sha.c" 2
# 28 "/home/converse/virtual_platform1/testsuit/standalone/sha-input_small/sha.c"
...
static void sha_transform(SHA_INFO *sha_info)
{
    ...
    D = sha_info->digest[3];
    E = sha_info->digest[4];
# 89 "/home/converse/virtual_platform1/testsuit/standalone/sha-input_small/sha.c"
    for (i = 0; i < 20; ++i) {
...
{
    int i,j;
    unsigned int size = _binary_input_small_bin_end - _binary_input_small_bin_start;
    BYTE data[8192];
    ...
    for(i = 0, j=0 ; i < size; i++) {
        ...
        data[j] = _binary_input_small_bin_start[i];
        j += 1;
...
# 246 "/home/converse/virtual_platform1/testsuit/standalone/sha-input_small/sha.c"
