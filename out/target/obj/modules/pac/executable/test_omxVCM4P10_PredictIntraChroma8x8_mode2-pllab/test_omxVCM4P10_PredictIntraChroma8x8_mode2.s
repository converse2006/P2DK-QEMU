	...
	;-----------------------------------------------------------
	; Compiling /home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntraChroma8x8_mode2.c (test_omxVCM4P10_PredictIntraChroma8x8_mode2.B)
	;-----------------------------------------------------------
	...
	.file	1	"/home/converse/virtual_platform1/out/target/obj/modules/pac/executable/test_omxVCM4P10_PredictIntraChroma8x8_mode2-pllab/<command-line>"
	.file	2	"/home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntraChroma8x8_mode2.c"
...
;	.savesp r7, 0
	...
	.loc	2	207	0
; 203      int *pDstp =(int *)pDst ;
; 204      int *pSrcAbovep = (int *)pSrcAbove ;
; 205  #endif
; 206  
; 207      switch (predMode)
...
.L_11_38:	; 0x17b1
 {  
	...
	.loc	2	238	0
; 234  		/***************/
; 235  		pDstp[y*dstStep_quar+x] = __builtin_copy(pSrcAbovep[x]);
; 236  		/***************/
; 237  		#else
; 238  		pDst[y*dstStep+x] = pSrcAbove[x];
	      addi a3,sp,84           		; [] pSrcAbove
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
; 243  
; 244      case 3:
; 245          H = 4*(pSrcAbove[7] - pSrcAboveLeft[0]);
	      addi a3,sp,84           		; [] pSrcAbove
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_40:	; 0x1964
 {  
	...
	.loc	2	248	0
; 247          {
; 248              H += (x+1)*(pSrcAbove[4+x] - pSrcAbove[2-x]);
	      lw d8,sp,40             		; [] H
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_41:	; 0x1a45
 {  
	...
	.loc	2	250	0
; 249          }
; 250          V = 4*(pSrcLeft[7*leftStep] - pSrcAboveLeft[0]);
	      addi a3,sp,96           		; [] leftStep
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_42:	; 0x1af4
 {  
	...
	.loc	2	253	0
; 252          {
; 253              V += (y+1)*(pSrcLeft[(4+y)*leftStep] - pSrcLeft[(2-y)*leftStep]);
	      lw d0,sp,44             		; [] V
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_43:	; 0x1c2a
 {  
	...
	.loc	2	255	0
; 254          }
; 255          a = 16*(pSrcAbove[7] + pSrcLeft[7*leftStep]);
	      addi a3,sp,96           		; [] leftStep
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
; 262                  Sum = (a + b*(x-3) + c*(y-3) + 16)>>5;
	      ...
	      nop                     		; [] 
	.loc	2	263	0
; 263                  pDst[y*dstStep+x] = Clip(0,255,Sum);
	      movi D8,0               		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
...
; 273  
; 274  
; 275  int Clip(int a, int b, int Sum)
; 276  {
 {  
;	.prologue
	      subi sp3,sp3,16 ;;      		; [] 
...
;	.gpvalue 0
	...
	.int.ua	0x38616d6f, 0x6d5f3878, 0x3265646f, 0x2f00632e
	...
	.int.ua	0x6c702d32, 0x0062616c, 0x6e65706f, 0x34206363
	...
	.int.ua	0x00209102, 0x01140206, 0x70696c43, 0x92030100
	.byte	0x30, 0x10
	.int.ua	.BB1_Clip
	.int.ua	.BB1_Clip + 0x14a
	.int.ua	0x000004d4, 0x01140207, 0x91020061, 0x14020700
	.int.ua	0x02006201, 0x02070491, 0x75530114, 0x9102006d
	.int.ua	0x02080008, 0x72610127, 0x4d43566d, 0x30315034
	...
	.int.ua	0x01270207, 0x63725370, 0x7466654c, 0x00910200
	.int.ua	0x01270207, 0x63725370, 0x766f6241, 0x91020065
	.int.ua	0x27020704, 0x73447001, 0x91020074, 0x27020708
	.int.ua	0x66656c01, 0x65745374, 0x91020070, 0x2702070c
	.int.ua	0x74736401, 0x70657453, 0x10910200, 0x01270207
	.int.ua	0x5f584d4f, 0x4c5f4356, 0x00544645, 0x07149102
	.int.ua	0x4f012702, 0x565f584d, 0x50555f43, 0x00524550
