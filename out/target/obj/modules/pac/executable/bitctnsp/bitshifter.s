	...
	;-----------------------------------------------------------
	; Compiling /home/converse/virtual_platform1/testsuit/hybrid/bitcount/bitcount/bitshifter.c (bitshifter.B)
	;-----------------------------------------------------------
	...
	.file	2	"/home/converse/virtual_platform1/testsuit/hybrid/bitcount/bitcount/bitshifter.c"
...
; BB:1 cycle count: 0
.BB1_bit_shifter:	; 0xc8
	.loc	2	8	0
;   4  #define CHAR_BIT 8
;   5  #endif /* CHAR_BIT */
;   6  
;   7  int bit_shifter(long int x)
;   8  {
 {  
;	.prologue
	      subi sp3,sp3,16 ;;      		; [] 
...
;   9    int i, n;
;  10    
;  11    for (i = n = 0; x && (i < (sizeof(long) * CHAR_BIT)); ++i, x >>= 1)
	      movi D8,0               		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
...
; Block: 2 Pred: 1 Succ: 3 6 
; BB:2 cycle count: 0
.BB2_bit_shifter:	; 0x11d
 {  
	      nop ;;                  		; [] 
	      lw d0,sp,4              		; [] i
	      nop                     		; [] 
...
; Block: 5 Pred: 4 Succ: 6 3 
; BB:5 cycle count: 0
.BB5_bit_shifter:	; 0x1db
 {  
	      nop ;;                  		; [] 
	      lw d0,sp,4              		; [] i
	      nop                     		; [] 
...
;	.gpvalue 0
	...
	.int.ua	0x746e756f, 0x7469622f, 0x66696873, 0x2e726574
	...
	.int.ua	0x000000e8, 0x6d630403, 0x02006773, 0x02000091
	.int.ua	0x70706604, 0x6e65735f, 0x626d5f64, 0x0300786f
	.byte	0x92, 0x30, 0x20
	.int.ua	.BB1_pp_send_mbox
	.int.ua	.BB1_pp_send_mbox + 0x64
	.int.ua	0x00000113, 0x6d660403, 0x02006773, 0x04000091
	.int.ua	0x69620802, 0x68735f74, 0x65746669, 0x03010072
	.byte	0x92, 0x30, 0x10
	.int.ua	.BB1_bit_shifter
	.int.ua	.BB1_bit_shifter + 0x172
	.byte	0x03, 0x02, 0x08, 0x78, 0x00, 0x02, 0x91, 0x00
	.byte	0x00, 0x00, 0x00
	...
	.int.ua	.BB1_pp_wait_mbox
	.int.ua	.BB1_bit_shifter - .BB1_pp_wait_mbox + 0x172
	.byte	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

	.section .debug_pubnames, "", "progbits"
	.align	0
	.byte	0x1e, 0x00, 0x00, 0x00, 0x02, 0x00
	.int.ua	.debug_info
	.int.ua	0x0000013a, 0x00000113, 0x5f746962, 0x66696873
	.byte	0x74, 0x65, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00
