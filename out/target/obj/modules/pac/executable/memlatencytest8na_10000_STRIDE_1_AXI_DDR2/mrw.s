	...
	.file	1	"/home/converse/virtual_platform1/out/target/obj/modules/pac/executable/memlatencytest8na_10000_STRIDE_1_AXI_DDR2/<command-line>"
...
.BB4_main:	; 0x181
 {  
	...
	.loc	2	47	0
;  43      puts("WRITE\n");
;  44  #elif defined(OP_NOP)
;  45      puts("NOP\n");
;  46  #elif defined(OP_NA)
;  47      puts("NA\n");
	      addi a3,gp,@ltoff(.rodata#)		; [] .rodata
	      nop                     		; [] 
	      nop                     		; [] 
...
nop;
 ...
 {  
	      ...
	      nop                     		; [] 
	.loc	2	122	0
; 118  /* Set the stride length only when the LOOP iteration is 10000. */
; 119  #if defined (LOOP_10000)
; 120      #if defined (STRIDE_1)
; 121          asm("{\nmoviu r3, 1;\nnop;\nnop;\nnop;\nnop;\n}\n");
; 122          stride_length    =1;
	      movi D8,1               		; [] 
 } {  
...
;	.gpvalue 0
	...
	.align	0
	.byte	0x44, 0x01, 0x00, 0x00, 0x02, 0x00
	.int.ua	.debug_abbrev
	...
	.int.ua	0x74736574, 0x5f616e38, 0x30303031, 0x54535f30
	.int.ua	0x45444952, 0x415f315f, 0x445f4958, 0x00325244
	...
	.int.ua	.debug_info
	.int.ua	0x00000148, 0x00000131, 0x6e69616d, 0x00000000
	.byte	0x00
