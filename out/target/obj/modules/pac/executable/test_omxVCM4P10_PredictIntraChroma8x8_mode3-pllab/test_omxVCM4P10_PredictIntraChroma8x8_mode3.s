	...
	;-----------------------------------------------------------
	; Compiling /home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntraChroma8x8_mode3.c (test_omxVCM4P10_PredictIntraChroma8x8_mode3.B)
	;-----------------------------------------------------------
	...
	.file	1	"/home/converse/virtual_platform1/out/target/obj/modules/pac/executable/test_omxVCM4P10_PredictIntraChroma8x8_mode3-pllab/<command-line>"
	.file	2	"/home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntraChroma8x8_mode3.c"
...
;	.savesp r7, 0
	...
	.loc	2	207	0
; 203      int tmp1, tmp2, temp, temp1 ;
; 204      pDstp = (int *)pDst ; // by wychen
; 205  #endif
; 206  
; 207      switch (predMode)
...
.L_11_34:	; 0x15e0
 {  
	...
	.loc	2	221	0
; 220              {
; 221                  pDst[y*dstStep+x] = pSrcLeft[y*leftStep];
	      addi a3,sp,96           		; [] leftStep
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_38:	; 0x17b1
 {  
	...
	.loc	2	231	0
; 230              {
; 231                  pDst[y*dstStep+x] = pSrcAbove[x];
	      addi a3,sp,84           		; [] pSrcAbove
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
; 235  
; 236      case 3:
; 237          H = 4*(pSrcAbove[7] - pSrcAboveLeft[0]);
	      addi a3,sp,84           		; [] pSrcAbove
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_40:	; 0x1964
 {  
	...
	.loc	2	240	0
; 239          {
; 240              H += (x+1)*(pSrcAbove[4+x] - pSrcAbove[2-x]);
	      lw d8,sp,40             		; [] H
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_41:	; 0x1a45
 {  
	...
	.loc	2	242	0
; 241          }
; 242          V = 4*(pSrcLeft[7*leftStep] - pSrcAboveLeft[0]);
	      addi a3,sp,96           		; [] leftStep
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_42:	; 0x1af4
 {  
	...
	.loc	2	245	0
; 244          {
; 245              V += (y+1)*(pSrcLeft[(4+y)*leftStep] - pSrcLeft[(2-y)*leftStep]);
	      lw d0,sp,44             		; [] V
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_43:	; 0x1c2a
 {  
	...
	.loc	2	247	0
; 246          }
; 247          a = 16*(pSrcAbove[7] + pSrcLeft[7*leftStep]);
	      addi a3,sp,96           		; [] leftStep
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_46:	; 0x1d6a
 {  
	      nop ;;                  		; [] 
	.loc	2	264	0
; 260                      temp = __builtin_dotp2(tmp1, tmp2) ;
; 261                      //temp1 = __builtin_mergea(__builtin_mul_d(tmp1, tmp2)) ;
; 262                      Sum = (a + temp + 16) >> 5 ;
; 263                  #else
; 264                      Sum = (a + b*(x-3) + c*(y-3) + 16)>>5;
	      lw d8,sp,48             		; [] a
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
; 267  
; 268  		        #ifdef INTRN	    
; 269  		            pDst[y*dstStep+x] = __builtin_limbucp(Sum) ;
; 270  		        #else
; 271  		            pDst[y*dstStep+x] = Clip(0,255,Sum);
	      movi D8,0               		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
...
; 283  
; 284  
; 285  int Clip(int a, int b, int Sum)
; 286  {
 {  
;	.prologue
	      subi sp3,sp3,16 ;;      		; [] 
...
;	.gpvalue 0
	...
	.int.ua	0x38616d6f, 0x6d5f3878, 0x3365646f, 0x2f00632e
	...
	.int.ua	0x6c702d33, 0x0062616c, 0x6e65706f, 0x34206363
	...
	.int.ua	0x000003c0, 0x70650203, 0x4c637253, 0x00746665
	...
	.int.ua	0x0000049c, 0x70c30203, 0x4c637253, 0x00746665
	...
	.int.ua	0x00209102, 0x011e0206, 0x70696c43, 0x92030100
	.byte	0x30, 0x10
	.int.ua	.BB1_Clip
	.int.ua	.BB1_Clip + 0x14a
	.int.ua	0x000004d4, 0x011e0207, 0x91020061, 0x1e020700
	.int.ua	0x02006201, 0x02070491, 0x7553011e, 0x9102006d
	.int.ua	0x02080008, 0x72610131, 0x4d43566d, 0x30315034
	...
	.int.ua	0x01310207, 0x63725370, 0x7466654c, 0x00910200
	.int.ua	0x01310207, 0x63725370, 0x766f6241, 0x91020065
	.int.ua	0x31020704, 0x73447001, 0x91020074, 0x31020708
	.int.ua	0x66656c01, 0x65745374, 0x91020070, 0x3102070c
	.int.ua	0x74736401, 0x70657453, 0x10910200, 0x01310207
	.int.ua	0x5f584d4f, 0x4c5f4356, 0x00544645, 0x07149102
	.int.ua	0x4f013102, 0x565f584d, 0x50555f43, 0x00524550
