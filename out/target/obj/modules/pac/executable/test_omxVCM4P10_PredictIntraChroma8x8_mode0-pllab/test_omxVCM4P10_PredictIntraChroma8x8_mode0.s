	...
	;-----------------------------------------------------------
	; Compiling /home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntraChroma8x8_mode0.c (test_omxVCM4P10_PredictIntraChroma8x8_mode0.B)
	;-----------------------------------------------------------
	...
	.file	1	"/home/converse/virtual_platform1/out/target/obj/modules/pac/executable/test_omxVCM4P10_PredictIntraChroma8x8_mode0-pllab/<command-line>"
	.file	2	"/home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntraChroma8x8_mode0.c"
	.file	3	"/home/converse/virtual_platform1/testsuit/standalone/nthu/H264/checksum.h"
...
armVCM4P10_PredictIntraDCUp4x4#:	; 0x60e
	; x = 8
	; y = 12
	; Sum = 0
	; Count = 4
...
; BB:1 cycle count: 0
.BB1_armVCM4P10_PredictIntraDCUp4x4:	; 0x60e
	.loc	2	37	0
;  33       int dstStep,
;  34       int OMX_VC_LEFT,
;  35       int OMX_VC_UPPER       
...
; BB:2 cycle count: 0
.BB2_armVCM4P10_PredictIntraDCUp4x4:	; 0x654
 {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	.loc	2	56	0
;  52              unpack_tmp = __builtin_unpack4(pSrcAbovep[0]) ;
;  53              tmp1 = __builtin_add_d(__builtin_get64h(unpack_tmp), __builtin_get64l(unpack_tmp)) ;
;  54              Sum += __builtin_mergea(tmp1) ;
;  55          #else
;  56          for (x=0; x<4; x++)
	      movi D8,0               		; [] 
 } {  
...
; BB:7 cycle count: 0
.BB7_armVCM4P10_PredictIntraDCUp4x4:	; 0x780
 {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	.loc	2	70	0
;  66              unpack_tmp = __builtin_unpack4(pSrcLeftp[0]) ;
;  67              tmp1 = __builtin_add_d(__builtin_get64h(unpack_tmp), __builtin_get64l(unpack_tmp)) ;
;  68              Sum += __builtin_mergea(tmp1) ;
;  69          #else
;  70          for (y=0; y<4; y++)
	      movi D8,0               		; [] 
 } {  
...
; BB:12 cycle count: 0
.BB12_armVCM4P10_PredictIntraDCUp4x4:	; 0x8b6
 {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	.loc	2	79	0
...
;  81      else
;  82    {
;  83  	//tmp2 = __builtin_permh2(w1, a2, 0, 2) ;
;  84          Sum = (Sum + 2) >> 2;
	      lw d0,sp,0              		; [] Sum
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_8_26:	; 0x8f7
 {  
	...
	.loc	2	91	0
;  87      #ifdef INTRN
;  88          temp = __builtin_pack4(Sum, Sum) ;
;  89          temp = __builtin_pack4(temp, temp) ;
;  90      #endif
;  91      for (y=0; y<4; y++)
	      movi D8,0               		; [] 
 } {  
...
armVCM4P10_PredictIntraDCLeft4x4#:	; 0xa9b
	; x = 12
	; y = 8
	; Sum = 0
	; Count = 4
...
; Block: 1 Pred: Succ: 2 6 
; BB:1 cycle count: 0
.BB1_armVCM4P10_PredictIntraDCLeft4x4:	; 0xa9b
	.loc	2	131	0
; 127       int dstStep,
; 128       int OMX_VC_LEFT,
; 129       int OMX_VC_UPPER        
; 130  )
; 131  {
 {  
;	.prologue
...
;	.savesp r7, 0
	      sw r7,sp3,16 ;;         		; [] lcl_spill_temp_4
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	.loc	2	132	0
; 132      int x, y, Sum=0, Count = 0;
	      movi D8,0               		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      ...
	      nop ;;                  		; [] 
	.loc	2	142	0
; 138          long long unpack_tmp ;
; 139          int tmp1 = 0, temp ;
; 140          int dstStep_quar = dstStep >> 2 ;
; 141      #endif
; 142      if (OMX_VC_LEFT)
	      addi a3,sp,52           		; [] OMX_VC_LEFT
	      nop                     		; [] 
...
; Block: 2 Pred: 1 Succ: 3 5 
; BB:2 cycle count: 0
.BB2_armVCM4P10_PredictIntraDCLeft4x4:	; 0xae1
 {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	.loc	2	149	0
; 145              unpack_tmp = __builtin_unpack4(pSrcLeftp[0]) ;
; 146              tmp1 = __builtin_add_d(__builtin_get64h(unpack_tmp), __builtin_get64l(unpack_tmp)) ;
; 147              Sum += __builtin_mergea(tmp1) ;
; 148          #else
; 149          for (y=0; y<4; y++)
	      movi D8,0               		; [] 
 } {  
...
; Block: 7 Pred: 6 Succ: 8 10 
; BB:7 cycle count: 0
.BB7_armVCM4P10_PredictIntraDCLeft4x4:	; 0xc35
 {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	.loc	2	163	0
; 159              unpack_tmp = __builtin_unpack4(pSrcAbovep[0]) ;
; 160              tmp1 = __builtin_add_d(__builtin_get64h(unpack_tmp), __builtin_get64l(unpack_tmp)) ;
; 161              Sum += __builtin_mergea(tmp1) ;
; 162          #else
; 163          for (x=0; x<4; x++)
	      movi D8,0               		; [] 
 } {  
...
; Block: 12 Pred: 11 Succ: 14 
; BB:12 cycle count: 0
.BB12_armVCM4P10_PredictIntraDCLeft4x4:	; 0xd43
 {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	.loc	2	172	0
...
.L_9_26:	; 0xd84
 {  
	...
	.loc	2	182	0
; 178      #ifdef INTRN
; 179          temp = __builtin_pack4(Sum, Sum) ;
; 180          temp = __builtin_pack4(temp, temp) ;
; 181      #endif
; 182      for (y=0; y<4; y++)
	      movi D8,0               		; [] 
 } {  
...
;	.savesp r7, 0
	      sw r7,sp3,52 ;;         		; [] lcl_spill_temp_5
	      nop                     		; [] 
	      nop                     		; [] 
	.loc	2	232	0
; 231  	checksum_t sum ;
; 232  	omxVCM4P10_PredictIntraChroma8x8(pSrcLeft, pSrcAbove, pSrcAboveLeft, pDst, leftStep, dstStep, predMode, OMX_VC_LEFT, OMX_VC_UPPER);
...
omxVCM4P10_PredictIntraChroma8x8#:	; 0x10d6
	; y = 32
	; x = 36
	; Sum = 60
	; H = 40
...
; Block: 1 Pred: Succ: 2 6 
; BB:1 cycle count: 0
.BB1_omxVCM4P10_PredictIntraChroma8x8:	; 0x10d6
	.loc	2	251	0
; 247          int predMode,
; 248          int OMX_VC_LEFT,
; 249          int OMX_VC_UPPER
; 250           )
; 251  {
 {  
;	.prologue
...
; BB:2 cycle count: 0
.BB2_omxVCM4P10_PredictIntraChroma8x8:	; 0x1112
 {  
	      nop ;;                  		; [] 
	      addi a3,sp,104          		; [] predMode
	      nop                     		; [] 
...
; BB:3 cycle count: 0
.BB3_omxVCM4P10_PredictIntraChroma8x8:	; 0x1149
 {  
	      nop ;;                  		; [] 
	      addi a3,sp,104          		; [] predMode
	      nop                     		; [] 
...
; BB:4 cycle count: 0
.BB4_omxVCM4P10_PredictIntraChroma8x8:	; 0x1180
 {  
	      nop ;;                  		; [] 
	      addi a3,sp,104          		; [] predMode
	      nop                     		; [] 
...
; BB:5 cycle count: 0
.BB5_omxVCM4P10_PredictIntraChroma8x8:	; 0x11b7
 {  
	      j .Lt_11_2 ;;           		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
; 255      {
; 256      case 0:
; 257          armVCM4P10_PredictIntraDC4x4(       pSrcLeft,            pSrcAbove,   pDst,             leftStep, dstStep, OMX_VC_LEFT, OMX_VC_UPPER);
...
; BB:7 cycle count: 0
.BB7_omxVCM4P10_PredictIntraChroma8x8:	; 0x1298
 {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	.loc	2	258	0
; 258          armVCM4P10_PredictIntraDCUp4x4(     pSrcLeft,            pSrcAbove+4, pDst+4,           leftStep, dstStep, OMX_VC_LEFT, OMX_VC_UPPER);
...
; BB:8 cycle count: 0
.BB8_omxVCM4P10_PredictIntraChroma8x8:	; 0x1360
 {  
	      nop ;;                  		; [] 
	.loc	2	259	0
; 259          armVCM4P10_PredictIntraDCLeft4x4(   pSrcLeft+4*leftStep, pSrcAbove,   pDst+4*dstStep,   leftStep, dstStep, OMX_VC_LEFT, OMX_VC_UPPER);
...
; BB:9 cycle count: 0
.BB9_omxVCM4P10_PredictIntraChroma8x8:	; 0x1455
 {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	.loc	2	260	0
; 260          armVCM4P10_PredictIntraDC4x4(       pSrcLeft+4*leftStep, pSrcAbove+4, pDst+4+4*dstStep, leftStep, dstStep, OMX_VC_LEFT, OMX_VC_UPPER);
	      addi A3,sp2,96          		; [] leftStep
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
...
; BB:10 cycle count: 0
.BB10_omxVCM4P10_PredictIntraChroma8x8:	; 0x154a
 {  
	.loc	2	261	0
; 261          break;
	      j .Lt_11_2 ;;           		; [] 
...
.L_11_34:	; 0x15e0
 {  
	...
	.loc	2	268	0
; 267              {
; 268                  pDst[y*dstStep+x] = pSrcLeft[y*leftStep];
	      addi a3,sp,96           		; [] leftStep
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_38:	; 0x17b1
 {  
	...
	.loc	2	278	0
; 277              {
; 278                  pDst[y*dstStep+x] = pSrcAbove[x];
	      addi a3,sp,84           		; [] pSrcAbove
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
; 282  
; 283      case 3:
; 284          H = 4*(pSrcAbove[7] - pSrcAboveLeft[0]);
	      addi a3,sp,84           		; [] pSrcAbove
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_40:	; 0x1964
 {  
	...
	.loc	2	287	0
; 286          {
; 287              H += (x+1)*(pSrcAbove[4+x] - pSrcAbove[2-x]);
	      lw d8,sp,40             		; [] H
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_41:	; 0x1a45
 {  
	...
	.loc	2	289	0
; 288          }
; 289          V = 4*(pSrcLeft[7*leftStep] - pSrcAboveLeft[0]);
	      addi a3,sp,96           		; [] leftStep
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_42:	; 0x1af4
 {  
	...
	.loc	2	292	0
; 291          {
; 292              V += (y+1)*(pSrcLeft[(4+y)*leftStep] - pSrcLeft[(2-y)*leftStep]);
	      lw d0,sp,44             		; [] V
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
.L_11_43:	; 0x1c2a
 {  
	...
	.loc	2	294	0
; 293          }
; 294          a = 16*(pSrcAbove[7] + pSrcLeft[7*leftStep]);
	      addi a3,sp,96           		; [] leftStep
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
; 301                  Sum = (a + b*(x-3) + c*(y-3) + 16)>>5;
	      ...
	      nop                     		; [] 
	.loc	2	302	0
; 302                  pDst[y*dstStep+x] = Clip(0,255,Sum);
	      movi D8,0               		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
...
; BB:32 cycle count: 0
.BB32_omxVCM4P10_PredictIntraChroma8x8:	; 0x1e2d
 {  
	      nop ;;                  		; [] 
	      lw d8,sp,36             		; [] x
	      nop                     		; [] 
...
; 311  
; 312  
; 313  int Clip(int a, int b, int Sum)
; 314  {
 {  
;	.prologue
	      subi sp3,sp3,16 ;;      		; [] 
...
.BB7_Clip:	; 0x2085
 {  
	      lw r7,sp3,0 ;;          		; [] lcl_spill_temp_7
	      lw d4,sp,4              		; [] lcl_spill_temp_8
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
 } {  
...
;PU cycle count: 0.000000
	...
	.global	armVCM4P10_PredictIntraDC4x4#
armVCM4P10_PredictIntraDC4x4#:	; 0x20b2
	; x = 12
	; y = 8
	; Sum = 0
	; Count = 4
...
; Block: 1 Pred: Succ: 2 6 
; BB:1 cycle count: 0
.BB1_armVCM4P10_PredictIntraDC4x4:	; 0x20b2
	.loc	2	333	0
; 329       int dstStep,
; 330       int OMX_VC_LEFT,
; 331       int OMX_VC_UPPER        
; 332  )
; 333  {
 {  
;	.prologue
...
;	.savesp r7, 0
	      sw r7,sp3,16 ;;         		; [] lcl_spill_temp_9
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	.loc	2	334	0
; 334      int x, y, Sum = 0, Count = 0;
	      movi D8,0               		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      ...
	      nop ;;                  		; [] 
	.loc	2	344	0
; 340      int dstStep_quar = dstStep >> 2 ;
; 341      int tmp1, temp = 0 ;
; 342      long long unpack_tmp ;
; 343      #endif
; 344      if (OMX_VC_LEFT)
	      addi a3,sp,52           		; [] OMX_VC_LEFT
	      nop                     		; [] 
...
; Block: 2 Pred: 1 Succ: 3 5 
; BB:2 cycle count: 0
.BB2_armVCM4P10_PredictIntraDC4x4:	; 0x20f8
 {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	.loc	2	351	0
; 347              unpack_tmp = __builtin_unpack4(pSrcLeftp[0]) ;
; 348              tmp1 = __builtin_add_d(__builtin_get64h(unpack_tmp), __builtin_get64l(unpack_tmp)) ;
; 349              Sum += __builtin_mergea(tmp1) ;
; 350          #else
; 351          for (y=0; y<4; y++)
	      movi D8,0               		; [] 
 } {  
...
; Block: 7 Pred: 6 Succ: 8 10 
; BB:7 cycle count: 0
.BB7_armVCM4P10_PredictIntraDC4x4:	; 0x2233
 {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
	.loc	2	365	0
; 361              unpack_tmp = __builtin_unpack4(pSrcAbovep[0]) ;
; 362              tmp1 = __builtin_add_d(__builtin_get64h(unpack_tmp), __builtin_get64l(unpack_tmp)) ;
; 363              Sum += __builtin_mergea(tmp1) ;
; 364          #else
; 365          for (x=0; x<4; x++)
	      movi D8,0               		; [] 
 } {  
...
; BB:12 cycle count: 0
.BB12_armVCM4P10_PredictIntraDC4x4:	; 0x2341
 {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	.loc	2	374	0
...
; BB:14 cycle count: 0
.BB14_armVCM4P10_PredictIntraDC4x4:	; 0x2396
 {  
	      nop ;;                  		; [] 
	.loc	2	378	0
; 377      {
...
.L_13_27:	; 0x23eb
 {  
	...
	.loc	2	388	0
; 384      #ifdef INTRN
; 385          temp = __builtin_pack4(Sum, Sum) ;
; 386          temp = __builtin_pack4(temp, temp) ;
; 387      #endif
; 388      for (y=0; y<4; y++)
	      movi D8,0               		; [] 
 } {  
...
;	.gpvalue 0
	...
	.align	0
	.byte	0x74, 0x05, 0x00, 0x00, 0x02, 0x00
	.int.ua	.debug_abbrev
	...
	.int.ua	0x38616d6f, 0x6d5f3878, 0x3065646f, 0x2f00632e
	...
	.int.ua	0x6c702d30, 0x0062616c, 0x6e65706f, 0x34206363
	.byte	0x2e, 0x30, 0x00, 0x01, 0x00
	.int.ua	.debug_line
	.int.ua	0x63090302, 0x64615f6b, 0x00385f64, 0x00309203
	.int.ua	.BB1_ck_add_8
	.int.ua	.BB1_ck_add_8 + 0x91
	.int.ua	0x00000130, 0x63090303, 0x00910200, 0x78090303
	...
	.int.ua	0x0000016b, 0x630e0303, 0x00910200, 0x610e0303
	.int.ua	0x02007272, 0x03030491, 0x7a69730e, 0x91020065
	.int.ua	0x03020008, 0x5f6b6317, 0x5f646461, 0x03003631
	.byte	0x92, 0x30, 0x00
	.int.ua	.BB1_ck_add_16
	.int.ua	.BB1_ck_add_16 + 0x91
	.int.ua	0x00000199, 0x63170303, 0x00910200, 0x78170303
	.int.ua	0x04910200, 0x1c030200, 0x615f6b63, 0x5f616464
	.byte	0x31, 0x36, 0x00, 0x03, 0x92, 0x30, 0x20
	.int.ua	.BB1_ck_adda_16
	.int.ua	.BB1_ck_adda_16 + 0x127
	.int.ua	0x000001d5, 0x631c0303, 0x00910200, 0x611c0303
	.int.ua	0x02007272, 0x03030491, 0x7a69731c, 0x91020065
	.int.ua	0x03020008, 0x5f6b6324, 0x74696e69, 0x30920300
	.byte	0x00
	.int.ua	.BB1_ck_init
	.int.ua	.BB1_ck_init + 0x32
	.int.ua	0x000001f9, 0x63240303, 0x00910200, 0x29030200
	.byte	0x63, 0x6b, 0x5f, 0x61, 0x64, 0x64, 0x00, 0x03
	.byte	0x92, 0x30, 0x00
	.int.ua	.BB1_ck_add
	.int.ua	.BB1_ck_add + 0x91
	.int.ua	0x00000224, 0x63290303, 0x00910200, 0x78290303
	.int.ua	0x04910200, 0x2e030200, 0x615f6b63, 0x00616464
	.byte	0x03, 0x92, 0x30, 0x20
	.int.ua	.BB1_ck_adda
	.int.ua	.BB1_ck_adda + 0x127
	.int.ua	0x0000025d, 0x632e0303, 0x00910200, 0x612e0303
	.int.ua	0x02007272, 0x03030491, 0x7a69732e, 0x91020065
	.int.ua	0x03020008, 0x5f6b6336, 0x0074756f, 0x00309203
	.int.ua	.BB1_ck_out
	.int.ua	.BB1_ck_out + 0xb9
	.int.ua	0x00000280, 0x63360303, 0x00910200, 0x25020200
	...
	.int.ua	0x0000031f, 0x70250203, 0x4c637253, 0x00746665
	...
	.int.ua	0x83020200, 0x566d7261, 0x50344d43, 0x505f3031
	...
	.int.ua	0x000003c0, 0x70830203, 0x4c637253, 0x00746665
	.int.ua	0x03009102, 0x53708302, 0x62416372, 0x0065766f
	.int.ua	0x03049102, 0x44708302, 0x02007473, 0x02030891
	.int.ua	0x66656c83, 0x65745374, 0x91020070, 0x8302030c
	.int.ua	0x53747364, 0x00706574, 0x03109102, 0x4d4f8302
	.int.ua	0x43565f58, 0x46454c5f, 0x91020054, 0x83020314
	.int.ua	0x5f584d4f, 0x555f4356, 0x52455050, 0x18910200
	.byte	0x00, 0x04, 0x02, 0xe6, 0x6d, 0x61, 0x69, 0x6e
	.byte	0x00, 0x01, 0x04, 0x92, 0x30, 0xc0, 0x00
	.int.ua	.BB1_main
	.int.ua	.BB1_main + 0x1ae
	.int.ua	0x6ffb0205, 0x4356786d, 0x3150344d, 0x72505f30
	...
	.int.ua	0x0000049c, 0x70fb0203, 0x4c637253, 0x00746665
	.int.ua	0x03009102, 0x5370fb02, 0x62416372, 0x0065766f
	.int.ua	0x03049102, 0x5370fb02, 0x62416372, 0x4c65766f
	.int.ua	0x00746665, 0x03089102, 0x4470fb02, 0x02007473
	.int.ua	0x02030c91, 0x66656cfb, 0x65745374, 0x91020070
	.int.ua	0xfb020310, 0x53747364, 0x00706574, 0x03149102
	.int.ua	0x7270fb02, 0x6f4d6465, 0x02006564, 0x02031891
	.int.ua	0x584d4ffb, 0x5f43565f, 0x5446454c, 0x1c910200
	.int.ua	0x4ffb0203, 0x565f584d, 0x50555f43, 0x00524550
	.int.ua	0x00209102, 0x013a0206, 0x70696c43, 0x92030100
	.byte	0x30, 0x10
	.int.ua	.BB1_Clip
	.int.ua	.BB1_Clip + 0x14a
	.int.ua	0x000004d4, 0x013a0207, 0x91020061, 0x3a020700
	.int.ua	0x02006201, 0x02070491, 0x7553013a, 0x9102006d
	.int.ua	0x02080008, 0x7261014d, 0x4d43566d, 0x30315034
	...
	.int.ua	0x014d0207, 0x63725370, 0x7466654c, 0x00910200
	.int.ua	0x014d0207, 0x63725370, 0x766f6241, 0x91020065
	.int.ua	0x4d020704, 0x73447001, 0x91020074, 0x4d020708
	.int.ua	0x66656c01, 0x65745374, 0x91020070, 0x4d02070c
	.int.ua	0x74736401, 0x70657453, 0x10910200, 0x014d0207
	.int.ua	0x5f584d4f, 0x4c5f4356, 0x00544645, 0x07149102
	.int.ua	0x4f014d02, 0x565f584d, 0x50555f43, 0x00524550
	...
	.int.ua	.BB1_ck_add_8
	.int.ua	.BB1_armVCM4P10_PredictIntraDC4x4 - .BB1_ck_add_8 + 0x4dd
	...
	.int.ua	.debug_info
	.int.ua	0x00000578, 0x000003c0, 0x6e69616d, 0x0003d600
	.int.ua	0x786d6f00, 0x344d4356, 0x5f303150, 0x64657250
	.int.ua	0x49746369, 0x6172746e, 0x6f726843, 0x7838616d
	.int.ua	0x049c0038, 0x6c430000, 0xd4007069, 0x61000004
