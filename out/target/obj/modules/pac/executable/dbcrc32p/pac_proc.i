# 1 "/home/converse/virtual_platform1/testsuit/hybrid/dbcrc32/pac_proc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/converse/virtual_platform1/testsuit/hybrid/dbcrc32/pac_proc.c"
...
{pp_mbox_send_w(msg);}
# 3 "/home/converse/virtual_platform1/testsuit/hybrid/dbcrc32/pac_proc.c" 2

# 1 "/home/converse/virtual_platform1/testsuit/hybrid/dbcrc32/mem.h" 1
# 5 "/home/converse/virtual_platform1/testsuit/hybrid/dbcrc32/pac_proc.c" 2
...
# 6 "/home/converse/virtual_platform1/testsuit/hybrid/dbcrc32/pac_proc.c" 2

typedef enum {Error_ = -1, Success_, False_ = 0, True_} Boolean_T;
# 25 "/home/converse/virtual_platform1/testsuit/hybrid/dbcrc32/pac_proc.c"
typedef uint32_t UNS_32_BITS;
# 74 "/home/converse/virtual_platform1/testsuit/hybrid/dbcrc32/pac_proc.c"
...
int task_end(uint32_t *d)
{
    ...
    *d = lastcrc32;
    outbuffer0[0] = (lastcrc32 >> 24) & 0xff;
    outbuffer0[1] = (lastcrc32 >> 16) & 0xff;
    outbuffer0[2] = (lastcrc32 >> 8) & 0xff;
    outbuffer0[3] = lastcrc32 & 0xff;
    ;
    return 0;
}
