	...
	.file	1	"/home/converse/virtual_platform1/out/target/obj/modules/pac/executable/memlatency8Wr_1024_STRIDE_1024_AXI_DDR2/<command-line>"
...
.BB5_main:	; 0x1bd
 {  
	      ...
	      nop                     		; [] 
	.loc	2	68	0
;  64      stride_length    =256;
;  65  #elif defined (STRIDE_512)
;  66      stride_length    =512;
;  67  #elif defined (STRIDE_1024)
;  68      stride_length    =1024;
	      movi d8,1024            		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
 } {  
...
;	.gpvalue 0
	...
	.align	0
	.byte	0x42, 0x01, 0x00, 0x00, 0x02, 0x00
	.int.ua	.debug_abbrev
	...
	.int.ua	0x5f725738, 0x34323031, 0x5254535f, 0x5f454449
	.int.ua	0x34323031, 0x4958415f, 0x5244445f, 0x706f0032
	...
	.int.ua	.debug_info
	.int.ua	0x00000146, 0x0000012f, 0x6e69616d, 0x00000000
	.byte	0x00
