	...
	;-----------------------------------------------------------
	; Compiling /home/converse/virtual_platform1/testsuit/standalone/nthu/DSPStone/complex_multiply_d.c (complex_multiply_d.B)
	;-----------------------------------------------------------
	...
	.file	1	"/home/converse/virtual_platform1/out/target/obj/modules/pac/executable/complex_multiply_d/<command-line>"
	.file	2	"/home/converse/virtual_platform1/testsuit/standalone/nthu/DSPStone/complex_multiply_d.c"
...
.BB1_pin_down:	; 0x45b
	.loc	2	34	0
;  30  #define TYPE  short
;  31  
;  32  void
;  33  pin_down(TYPE *ar, TYPE *ai, TYPE *br, TYPE *bi, TYPE *cr, TYPE *ci)
;  34  {
 {  
;	.unwentry
	      nop ;;                  		; [] 
...
;	.savesp r7, 0
	      ...
	      nop                     		; [] 
	.loc	2	65	0
;  61  	long long result = 0 ;
;  62   #endif
;  63    
;  64    #ifndef INTRN
;  65    	pin_down(&ar, &ai, &br, &bi, &cr, &ci) ;
	      addi D0,gp2,@gprel(.sbss#)		; [] ar
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
...
;  75  
;  76    #ifndef INTRN
;  77    	cr[0]  = ar[0]*br[0] - ai[0]*bi[0] ;
	      addi a3,gp,@gprel(.sbss#)		; [] ar
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
 } {  
	      ...
	      nop                     		; [] 
	.loc	2	78	0
;  78   	cr[1]  = ar[1]*br[1] + ai[1]*bi[1] ;
	      addi A3,gp2,@gprel(.sbss#+2)		; [] ar+2
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      ...
	      nop                     		; [] 
	      nop                     		; [] 
	      addi A3,gp2,@gprel(.sbss#+10)		; [] br+2
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      ...
	      nop                     		; [] 
	      nop                     		; [] 
	      addi A3,gp2,@gprel(.sbss#+14)		; [] bi+2
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      ...
	      nop                     		; [] 
	      nop                     		; [] 
	      addi A3,gp2,@gprel(.sbss#+18)		; [] cr+2
	      add D8,D10,D11          		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
	      ...
	      nop                     		; [] 
	.loc	2	79	0
;  79    	ci[0]  = ar[0]*bi[0] + ai[0]*br[0] ;
	      addi A3,gp2,@gprel(.sbss#)		; [] ar
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
...
;  80    	ci[1]  = ar[1]*bi[1] - ai[1]*br[1] ;
	      ...
	      nop                     		; [] 
	      nop                     		; [] 
	      addi A3,gp2,@gprel(.sbss#+22)		; [] ci+2
	      sub D8,D10,D11          		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
...
;  99    END_PROFILING;
; 100  
; 101    //pin_down(&ar, &ai, &br, &bi, &cr, &ci) ; 
; 102    ck_init(&sum);
	      addi D0,sp2,32          		; [] sum
	      nop                     		; [] 
 } {  
...
.BB4_main:	; 0x7f3
 {  
	      ...
	      nop                     		; [] 
	.loc	2	104	0
; 104    ck_add_16(&sum, cr[1]);
	      addi D0,sp2,32          		; [] sum
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      addi a3,gp,@gprel(.sbss#+18)		; [] cr+2
	      nop                     		; [] 
	      sw D0,sp2,0             		; [] 
	      nop                     		; [] 
 } {  
...
.BB5_main:	; 0x82a
 {  
	      ...
	      nop                     		; [] 
	.loc	2	105	0
; 105    ck_add_16(&sum, ci[0]);
	      addi D0,sp2,32          		; [] sum
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      addi a3,gp,@gprel(.sbss#+20)		; [] ci
	      nop                     		; [] 
	      sw D0,sp2,0             		; [] 
	      nop                     		; [] 
 } {  
...
.BB6_main:	; 0x861
 {  
	      ...
	      nop                     		; [] 
	.loc	2	106	0
; 106    ck_add_16(&sum, ci[1]);
	      addi D0,sp2,32          		; [] sum
	      nop                     		; [] 
 } {  
	      nop ;;                  		; [] 
	      addi a3,gp,@gprel(.sbss#+22)		; [] ci+2
	      nop                     		; [] 
	      sw D0,sp2,0             		; [] 
	      nop                     		; [] 
 } {  
...
;	.gpvalue 0
	...
	.align	0
	.byte	0x4b, 0x02, 0x00, 0x00, 0x02, 0x00
	.int.ua	.debug_abbrev
	...
	.int.ua	0x656e6f74, 0x6d6f632f, 0x78656c70, 0x6c756d5f
	.int.ua	0x6c706974, 0x2e645f79, 0x682f0063, 0x2f656d6f
	...
	.int.ua	0x6d6f632f, 0x78656c70, 0x6c756d5f, 0x6c706974
	.int.ua	0x00645f79, 0x6e65706f, 0x34206363, 0x0100302e
	.byte	0x00
	.int.ua	.debug_line
	...
	.int.ua	0x000000fd, 0x63090303, 0x00910200, 0x78090303
	...
	.int.ua	0x00000139, 0x630e0303, 0x00910200, 0x610e0303
	...
	.int.ua	0x000001e4, 0x63280303, 0x00910200, 0x22020400
	.byte	0x70, 0x69, 0x6e, 0x5f, 0x64, 0x6f, 0x77, 0x6e
	.byte	0x00, 0x01, 0x03, 0x92, 0x30, 0x00
	.int.ua	.BB1_pin_down
	.int.ua	.BB1_pin_down + 0x104
	.int.ua	0x00000238, 0x61220203, 0x91020072, 0x22020300
	.int.ua	0x02006961, 0x02030491, 0x00726222, 0x03089102
	.int.ua	0x69622202, 0x0c910200, 0x63220203, 0x91020072
	.int.ua	0x22020310, 0x02006963, 0x05001491, 0x616d3002
	.byte	0x69, 0x6e, 0x00, 0x01, 0x03, 0x92, 0x30, 0x30
	.int.ua	.BB1_main
	.int.ua	.BB1_main + 0x389
	.byte	0x00, 0x00
	...
	.int.ua	.BB1_ck_add_16
	.int.ua	.BB1_main - .BB1_ck_add_16 + 0x389
	...
	.int.ua	.debug_info
	.int.ua	0x0000024f, 0x000001e4, 0x5f6e6970, 0x6e776f64
	.byte	0x00, 0x38, 0x02, 0x00, 0x00, 0x6d, 0x61, 0x69
