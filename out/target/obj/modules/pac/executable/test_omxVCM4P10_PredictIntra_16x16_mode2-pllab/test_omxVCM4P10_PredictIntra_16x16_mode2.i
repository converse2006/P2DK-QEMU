# 1 "/home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntra_16x16_mode2.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntra_16x16_mode2.c"
# 30 "/home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntra_16x16_mode2.c"
...
# 31 "/home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntra_16x16_mode2.c" 2
    ...
    )
{
    ...
    int x,y,Sum,Count;
    int H,V,a,b,c;
# 88 "/home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntra_16x16_mode2.c"
    switch (predMode)
    {
    case 0:
        for (y=0; y<16; y++)
    ...
    case 2:
        ...
        if (OMX_VC_LEFT)
        {
# 124 "/home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntra_16x16_mode2.c"
            for (y=0; y<16; y++)
            {
        ...
        if (OMX_VC_UPPER)
        {
# 141 "/home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntra_16x16_mode2.c"
            for (x=0; x<16; x++)
            {
                Sum += pSrcAbove[x];
            }
        ...
        for (y=0; y<16; y++)
        {
# 170 "/home/converse/virtual_platform1/testsuit/standalone/nthu/H264/test_omxVCM4P10_PredictIntra_16x16_mode2.c"
            for (x=0; x<16; x++)
            {
