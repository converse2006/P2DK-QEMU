	...
	;-----------------------------------------------------------
	; Compiling /home/converse/virtual_platform1/testsuit/standalone/ccr_mrw8/mrw.c (mrw.B)
	;-----------------------------------------------------------
	...
	.file	1	"/home/converse/virtual_platform1/out/target/obj/modules/pac/executable/8mnatest_1024/<command-line>"
	.file	2	"/home/converse/virtual_platform1/testsuit/standalone/ccr_mrw8/mrw.c"
...
.BB3_main:	; 0x136
 {  
	...
	.loc	2	27	0
;  23      puts("AXI_SRM ");
;  24  #elif defined(LOC_AHB_SDRM)
;  25      puts("AHB_SDRM ");
;  26  #elif defined(LOC_AHB_SRM)
;  27      puts("AHB_SRM ");
	      addi a3,gp,@ltoff(.rodata#)		; [] .rodata
	      nop                     		; [] 
	      nop                     		; [] 
...
.BB4_main:	; 0x16d
 {  
	...
	.loc	2	39	0
;  35      puts("WRITE\n");
;  36  #elif defined(OP_NOP)
;  37      puts("NOP\n");
;  38  #elif defined(OP_NA)
;  39      puts("NA\n");
	      addi a3,gp,@ltoff(.rodata#)		; [] .rodata
	      nop                     		; [] 
	      nop                     		; [] 
...
.BB20_main:	; 0x3c9
 {  
	      nop ;;                  		; [] 
	.loc	2	261	0
; 261      puth(((uint32_t)&ccr_stop_clear_addr) - ((uint32_t)&ccr_start_addr));
	      addi d0,gp,@gprel(ccr_stop_clear_addr#)		; [] ccr_stop_clear_addr
	      nop                     		; [] 
	      nop                     		; [] 
	      nop                     		; [] 
...
;PU cycle count: 0.000000
	...
	.org 0x0
	; offset 0
	.byte	0xa, 0xa, 0x4d, 0x52, 0x57, 0x20, 0x54, 0x45	; \n\nMRW TE
	.byte	0x53, 0x54, 0x21, 0x20, 0x0	; ST! \000
	.org 0x10
	; offset 16
	.stringz "1024/32K "
	.org 0x1c
...
;	.gpvalue 0
	...
	.align	0
	.byte	0x1f, 0x01, 0x00, 0x00, 0x02, 0x00
	.int.ua	.debug_abbrev
	...
	.int.ua	0x6f6c6164, 0x632f656e, 0x6d5f7263, 0x2f387772
	...
	.int.ua	0x78652f63, 0x74756365, 0x656c6261, 0x6e6d382f
	.int.ua	0x73657461, 0x30315f74, 0x6f003432, 0x636e6570
	...
	.int.ua	.BB1_pp_wait_mbox
	.int.ua	.BB1_main - .BB1_pp_wait_mbox + 0x352
	...
	.int.ua	.debug_info
	.int.ua	0x00000123, 0x0000010c, 0x6e69616d, 0x00000000
	.byte	0x00
