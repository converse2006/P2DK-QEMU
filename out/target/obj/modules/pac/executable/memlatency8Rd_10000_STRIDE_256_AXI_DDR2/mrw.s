	...
	.file	1	"/home/converse/virtual_platform1/out/target/obj/modules/pac/executable/memlatency8Rd_10000_STRIDE_256_AXI_DDR2/<command-line>"
...
nop;
 ...
 {  
	...
	.loc	2	146	0
; 142          asm("{\nmoviu r3, 128;\nnop;\nnop;\nnop;\nnop;\n}\n");
; 143          stride_length    =128;
; 144      #elif defined (STRIDE_256)
; 145          asm("{\nmoviu r3, 256;\nnop;\nnop;\nnop;\nnop;\n}\n");
; 146          stride_length    =256;
	      movi D8,256             		; [] 
 } {  
	      nop ;;                  		; [] 
	      nop                     		; [] 
...
;	.gpvalue 0
	...
	.int.ua	0x3635325f, 0x4958415f, 0x5244445f, 0x706f0032
